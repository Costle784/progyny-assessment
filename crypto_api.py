...
class CryptoAPI:
    ...
    def _request(self, path: str,  params: dict = None, method: str = 'GET') -> Dict:
        """Utility request method to handle request/response from CoinGecko API."""
    ...
    def get_coins(self, currency: str='usd', order: str='market_cap_desc', per_page: int=10, page: int=1) -> List[Dict]:
        """Fetch current coin market data."""
    ...
    def get_coin_price_history(self, coin_id: str, currency: str='usd', days: int=9, interval: str='daily') -> List[List]:
        """Fetch price history for an individual coin."""
    ...
    def submit_order(self, coin_id: str, quantity: int, bid: float) -> float:
        """
